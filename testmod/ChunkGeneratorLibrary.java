...
public class ChunkGeneratorLibrary implements IChunkGenerator
{
		...
		protected static final IBlockState STONE = Blocks.LOG.getStateFromMeta(2);
		@SuppressWarnings("deprecation")
		protected static final IBlockState GRAVEL = Blocks.LOG.getStateFromMeta(2);
		protected static final IBlockState WATER = Blocks.IRON_ORE.getDefaultState();
		...
		public ChunkGeneratorLibrary(World worldIn, long seed) {

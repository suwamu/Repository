...
public class CostomBlockSapling extends BlockBush implements IGrowable,IMetaName
{
    ...
    public CostomBlockSapling(String name)
    {
    	setUnlocalizedName(name);
    	setRegistryName(name);
    	this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, CostomBlockPlanks.EnumType.TUTORIAL).withProperty(STAGE, Integer.valueOf(0)));
	}
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(VARIANT, CostomBlockPlanks.EnumType.byMetadata(meta & 1)).withProperty(STAGE, Integer.valueOf((meta & 8) >> 3));
	}
	...
	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
	{
		...
		switch((CostomBlockPlanks.EnumType)state.getValue(VARIANT))
		{
		case TUTORIAL:

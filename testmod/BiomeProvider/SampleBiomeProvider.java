...
public class SampleBiomeProvider extends BiomeProvider {
	...
	public SampleBiomeProvider(World world,Biome... biomes) 
	{
		this.biomeCache = new BiomeCache(this);
		GenLayer[] agenlayer = GenLayerFix.makeTheWorld(world.getSeed(), biomes);

...
public class CostomBiomeProvider extends BiomeProvider {

	private GenLayer genBiomes;
	private GenLayer biomeIndexLayer;
	private BiomeCache biomeCache;
	public static GenLayer layer;




	public CostomBiomeProvider(World world, Biome... biomes)
	{
		this.biomeCache = new BiomeCache(this);
		GenLayer[] agenlayer = makeTheWorld(world.getSeed());
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
		
		layer = new GenLayerBiomesCustom(1L,biomes);
	
	}



	public CostomBiomeProvider(World world)
	{
		this(world, Biomes.FOREST, Biomes.PLAINS, Biomes.TAIGA, Biomes.TAIGA_HILLS, Biomes.FOREST_HILLS, Biomes.JUNGLE, Biomes.JUNGLE_HILLS);
	}

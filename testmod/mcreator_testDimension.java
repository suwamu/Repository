...
public class mcreator_testDimension extends testenvironmentmod.ModElement {
	...
	static {
		...
		block = (ModTrigger) (new ModTrigger().setUnlocalizedName("testdimension_trigger"));
	}
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT) {
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(block, 0, new ModelResourceLocation("testenvironmentmod:testdimension_trigger", "inventory"));
		}
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		block.setRegistryName("testdimension_trigger");
		ForgeRegistries.ITEMS.register(block);
		dtype = DimensionType.register("testdimension", "_testdimension", DIMID, WorldProviderMod.class, true);
					...
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							this.world.setBlockState(new BlockPos(i2, j2, k2),
									flag ? Blocks.GOLD_ORE.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			...
			for (int i8 = 0; i8 < 4; ++i8) {
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12), flag1 ? Blocks.GOLD_ORE.getDefaultState() : iblockstate, 2);
					}
				}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != Blocks.GOLD_ORE.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == Blocks.GOLD_ORE.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.GOLD_ORE.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.GOLD_ORE
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("ocean")),
				Biome.REGISTRY.getObject(new ResourceLocation("beaches")), Biome.REGISTRY.getObject(new ResourceLocation("mesa")),};
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		protected static final IBlockState STONE = Blocks.MOSSY_COBBLESTONE.getDefaultState();
		protected static final IBlockState GRAVEL = Blocks.MOSSY_COBBLESTONE.getDefaultState();
		protected static final IBlockState WATER = Blocks.BROWN_MUSHROOM_BLOCK.getDefaultState();

...
{
	public static final IBlockState LOG = testmod.log.getDefaultState().withProperty(CostomBlockLog.VARIANT, CostomBlockPlanks.EnumType.TUTORIAL);
	public static final IBlockState LEAF = testmod.leaves.getDefaultState().withProperty(CostomLeaves.VARIANT, CostomBlockPlanks.EnumType.TUTORIAL);
